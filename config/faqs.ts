...
export const FAQS_ZH = [
  {
    title: "什么是一平米花园？",
    content:
      "一平米花园是一种针对小空间设计的迷你园艺方案，通过在1平方米左右（甚至更小）的空间内，通过合理规划、垂直分层、容器组合等方式，高效种植植物，实现“小而美”的种植或观赏目标。它适合城市阳台、窗台、露台、庭院角落等空间有限的场景，是都市人亲近自然、体验种植乐趣的便捷方式。",
  },
  {
    title: "一平米花园适合放在哪些空间？",
    content:
      "阳台、窗台、书桌、厨房台面等均可摆放。模块化设计灵活适配小户型，让任何角落都能变身绿色角落。",
  },
  {
    title: "种植需要每天花多少时间打理？",
    content:
      "每日仅需3-5分钟养护。配套智能水培套装+图文指导手册，浇水施肥更省心，适合工作繁忙的都市人。",
  },
  {
    title: "新手能养活这些植物吗？",
    content:
      "精选薄荷、多肉等12种易存活植物。每株配专属电子养护卡，光照水量提醒+专家在线答疑，零基础也能种好。",
  },
  {
    title: "使用这个室内种植会有蚊虫异味吗？",
    content:
      "采用无土栽培技术+环保基质，从源头杜绝虫卵滋生。推荐搭配迷迭香等芳香植物，空气更清新。",
  },
  {
    title: "搬家时花园怎么处理？",
    content:
      "轻量化材质可整体搬运，拆分后仅占0.2m³空间。赠送折叠收纳箱，租户也能安心打造移动花园。",
  },
  {
    title: "能种出可食用的蔬菜吗？",
    content:
      "提供罗勒、樱桃萝卜等6种速生菜苗套餐。搭配有机营养液，28天即可采收，满足都市人「从种子到沙拉」的趣味体验。",
  },
  {
    title: "如何让花园看起来更美观？",
    content:
      "提供6款北欧风/日式/工业风支架组件，支持自由拼色搭配。每月更新造景灵感图库，轻松打造INS风绿植角。",
  },
